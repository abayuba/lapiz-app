...
/**
 * @author abayuba  <abayuba1@gmail.com>
 * @copyright aplicacionesmoviles.uy 2017
 * @package lapiz_app
 * 
 * 
...
$config["dbase"] 		= "db_lapiz_app" ; 		//Database
$config["utf8"] 		= true ; 		//turkish charset set false
$config["abs_url_images"] 		= "http://domain.com/apps/lapiz_app//media/image/" ; 		//Absolute Images URL
$config["abs_url_videos"] 		= "http://domain.com/apps/lapiz_app//media/media/" ; 		//Absolute Videos URL
$config["abs_url_audios"] 		= "http://domain.com/apps/lapiz_app//media/media/" ; 		//Absolute Audio URL
$config["abs_url_files"] 		= "http://domain.com/apps/lapiz_app//media/file/" ; 		//Absolute Files URL
...
switch($_GET["json"]){	// TODO: -+- route
	case "route":		$rest_api=array();
		$rest_api["site"]["name"] = "Lapiz App" ;
		$rest_api["site"]["description"] = "Lápiz App" ;
		$rest_api["site"]["imabuilder"] = "rev17.08.29" ;
